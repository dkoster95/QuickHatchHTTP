...
public struct LogsShortcuts {
    ...
    public static let requestFactory = "\(LogsShortcuts.quickhatch)RequestFactory -> "
    public static let certificatePinner = "\(LogsShortcuts.quickhatch)CertificatePinner ->"
}
