...
public struct QHCertificatePinner: CertificatePinner {
    ...
    public func isServerTrusted(challenge: URLAuthenticationChallenge) -> Bool {
        ...
        guard let pinningStrategiesForHost = pinningStrategies[challenge.protectionSpace.host] else { return false }
        return pinningStrategiesForHost.contains(where: { return $0.validate(serverTrust: serverTrust) })
    }
