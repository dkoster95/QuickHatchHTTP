...
class URLSessionProtocolMock: URLSessionProtocol, @unchecked Sendable {
    ...
    func task(with request: URLRequest, completionHandler: @escaping (Data?, URLResponse?, Error?) -> Void) -> DataTask {
        let data = self.data
...
class URLSessionMockResponses: URLSessionProtocolMock, @unchecked Sendable {
    ...
    override func task(with request: URLRequest, completionHandler: @escaping (Data?, URLResponse?, Error?) -> Void) -> DataTask {
